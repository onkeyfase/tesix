...
int main(void)
{
  ...
  // Avvia il segnale PWM per la Peltier
...
/**
  * @brief Regola la tensione media sulla cella di Peltier
  * @param percentage: Valore da 0.0 a 100.0
  */
void Control_Peltier_Voltage(float percentage)
{
    ...
    // Con ARR = 799, il valore massimo del registro compare è 800
